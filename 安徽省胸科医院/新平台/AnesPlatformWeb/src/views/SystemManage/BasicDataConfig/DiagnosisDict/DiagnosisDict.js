...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        DIAGNOSIS_CODE: [
          { required: true, message: '请输入诊断代码', trigger: 'blur' }
        ],
        DIAGNOSIS_NAME: [
  ...
  methods: {
    ...
    searchData (index) {
      ...
      BasicConfigApi.GetDiagnosisDict({
    ...
    deleteData (index, row) {
      this.$confirm('确认删除该数据吗?', '提示', {
        ...
        .then(() => {
          ...
          BasicConfigApi.DeletedDiagnosisDict(OperationDict)
            .then(function (respose) {
    ...
    onSubmit (formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          var _this = this
          BasicConfigApi.EditDiagnosisDict(this.wayType, this.formData)
            .then(function (respose) {
