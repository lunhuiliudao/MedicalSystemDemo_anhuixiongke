<template>
  <div class="controlBreathEditDiv">
    <el-dialog
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="controlBreathEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button
          type="primary"
          class="controlBreathEditDivSave"
    ...
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="controlBreathEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="controlBreathEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="controlBreathEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="controlBreathEditDivDelete"
                  type="danger"
...
<script>
import ControlBreathEdit from './ControlBreathEdit.js'
export default ControlBreathEdit
</script>

<style lang="scss" scoped>
@import "@/assets/styles/global.scss";

.controlBreathEditDiv {
  margin-top: 5px;
  padding: 10px 0px;
...
<style>
.controlBreathEditDiv .el-input__inner {
...
.controlBreathEditDiv .el-input__icon {
  line-height: 25px;
}
.controlBreathEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.controlBreathEditDiv .el-table th {
  padding: 6px 0;
}

.controlBreathEditDiv .el-table td {
  padding: 4px 0;
}

.controlBreathEditDiv .el-input-number {
  line-height: 24px;
}

.controlBreathEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.controlBreathEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .controlBreathEditDiv .el-form-item__label {
    font-size: 12px;
