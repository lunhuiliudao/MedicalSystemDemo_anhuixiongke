  ...
  <div class="inBloodEditDiv">
    ...
    >
      <el-form :model="formData" :rules="rules" ref="formView" :inline="true">
        ...
        <el-form-item label="用药途径">
          ...
          >
            <el-option
              style="font-size:14px;padding:0px 5px;"
              v-for="item in medAdministratorList"
              :key="item.ADMINISTRATION_NAME"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="inBloodEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button type="primary" class="inBloodEditDivSave" @click="dialogEditVisible = false">取 消</el-button>
      </div>
    </el-dialog>
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="inBloodEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="inBloodEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center" fixed="right" min-width="120px">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="inBloodEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="inBloodEditDivDelete"
                  type="danger"
...
<script>
import InBloodEdit from './InBloodEdit.js'
export default InBloodEdit
</script>
...
<style>
.inBloodEditDiv .el-input__inner {
...
.inBloodEditDiv .el-input__icon {
  line-height: 25px;
}
.inBloodEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.inBloodEditDiv .el-table th {
  padding: 6px 0;
}

.inBloodEditDiv .el-table td {
  padding: 4px 0;
}

.inBloodEditDiv .el-input-number {
  line-height: 24px;
}

.inBloodEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.inBloodEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .inBloodEditDiv .el-form-item__label {
    font-size: 12px;
