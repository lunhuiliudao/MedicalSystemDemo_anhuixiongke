  ...
  <div class="pullPipeEditDiv">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="pullPipeEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button type="primary" class="pullPipeEditDivSave" @click="dialogEditVisible = false">取 消</el-button>
      </div>
    </el-dialog>
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="pullPipeEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="pullPipeEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="pullPipeEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="pullPipeEditDivDelete"
                  type="danger"
...
<script>
import PullPipeEdit from './PullPipeEdit.js'
export default PullPipeEdit
</script>
...
<style>
.pullPipeEditDiv .el-input__inner {
...
.pullPipeEditDiv .el-input__icon {
  line-height: 25px;
}
.pullPipeEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.pullPipeEditDiv .el-table th {
  padding: 6px 0;
}

.pullPipeEditDiv .el-table td {
  padding: 4px 0;
}

.pullPipeEditDiv .el-input-number {
  line-height: 24px;
}

.pullPipeEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}
...
@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .pullPipeEditDiv .el-form-item__label {
    font-size: 12px;
