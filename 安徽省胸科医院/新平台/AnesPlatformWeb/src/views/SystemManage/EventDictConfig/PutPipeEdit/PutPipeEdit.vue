  ...
  <div class="putPipeEditDiv">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="putPipeEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button type="primary" class="putPipeEditDivSave" @click="dialogEditVisible = false">取 消</el-button>
      </div>
    </el-dialog>
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="putPipeEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="putPipeEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="putPipeEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="putPipeEditDivDelete"
                  type="danger"
...
<script>
import PutPipeEdit from './PutPipeEdit.js'
export default PutPipeEdit
</script>
...
<style>
.putPipeEditDiv .el-input__inner {
...
.putPipeEditDiv .el-input__icon {
  line-height: 25px;
}
.putPipeEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.putPipeEditDiv .el-table th {
  padding: 6px 0;
}

.putPipeEditDiv .el-table td {
  padding: 4px 0;
}

.putPipeEditDiv .el-input-number {
  line-height: 24px;
}

.putPipeEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.putPipeEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .putPipeEditDiv .el-form-item__label {
    font-size: 12px;
