  ...
  <div class="helpBreathEditDiv">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="helpBreathEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button
          type="primary"
          class="helpBreathEditDivSave"
    ...
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="helpBreathEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="helpBreathEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="helpBreathEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="helpBreathEditDivDelete"
                  type="danger"
...
<script>
import HelpBreathEdit from './HelpBreathEdit.js'
export default HelpBreathEdit
</script>
...
<style>
.helpBreathEditDiv .el-input__inner {
...
.helpBreathEditDiv .el-input__icon {
  line-height: 25px;
}
.helpBreathEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.helpBreathEditDiv .el-table th {
  padding: 6px 0;
}

.helpBreathEditDiv .el-table td {
  padding: 4px 0;
}

.helpBreathEditDiv .el-input-number {
  line-height: 24px;
}

.helpBreathEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.helpBreathEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .helpBreathEditDiv .el-form-item__label {
    font-size: 12px;
