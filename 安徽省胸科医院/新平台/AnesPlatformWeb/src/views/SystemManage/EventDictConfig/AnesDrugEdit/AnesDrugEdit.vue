  ...
  <div class="anesDrugEditDiv">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="anesDrugEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button type="primary" class="anesDrugEditDivSave" @click="dialogEditVisible = false">取 消</el-button>
      </div>
    </el-dialog>
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="anesDrugEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="anesDrugEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
          ...
          <el-table-column label="操作" align="center" fixed="right" min-width="120px">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="anesDrugEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="anesDrugEditDivDelete"
                  type="danger"
...
<script>
import AnesDrugEdit from './AnesDrugEdit.js'
export default AnesDrugEdit
</script>
...
<style>
.anesDrugEditDiv .el-input__inner {
...
.anesDrugEditDiv .el-input__icon {
  line-height: 25px;
}
.anesDrugEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.anesDrugEditDiv .el-table th {
  padding: 6px 0;
}

.anesDrugEditDiv .el-table td {
  padding: 4px 0;
}

.anesDrugEditDiv .el-input-number {
  line-height: 24px;
}

.anesDrugEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.anesDrugEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .anesDrugEditDiv .el-form-item__label {
    font-size: 12px;
