  ...
  <div class="inOxygenEditDiv">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" class="inOxygenEditDivSave" @click="onSubmit('formView')">保 存</el-button>&nbsp;&nbsp;&nbsp;&nbsp;
        <el-button type="primary" class="inOxygenEditDivSave" @click="dialogEditVisible = false">取 消</el-button>
      </div>
    </el-dialog>
    <div id="conditionView">
      <div style="margin:10px 10px 0px;height:26px">
        ...
        <div>
          <el-button type="primary" class="inOxygenEditDivAdd" @click="searchData(1)">查询</el-button>
          <el-button type="primary" class="inOxygenEditDivAdd" @click="addData">新增</el-button>
        </div>
      </div>
    </div>
    <div style="background-color: #fff;min-height:600px;">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="EVENT_ATTR" header-align="center" align="center" label="类别"></el-table-column>
          ...
          <el-table-column label="操作" align="center" min-width="120px">
            <template slot-scope="scope">
              <span class="czCss">
                <el-button
                  size="small"
                  class="inOxygenEditDivEdit"
                  @click="editData(scope.$index, scope.row)"
                >编辑</el-button>
                <el-button
                  size="small"
                  class="inOxygenEditDivDelete"
                  type="danger"
...
<script>
import InOxygenEdit from './InOxygenEdit.js'
export default InOxygenEdit
</script>
...
<style>
.inOxygenEditDiv .el-input__inner {
...
.inOxygenEditDiv .el-input__icon {
  line-height: 25px;
}
.inOxygenEditDiv .el-button {
  display: inline-block;
  line-height: 1;
  white-space: nowrap;
  cursor: pointer;
...
.inOxygenEditDiv .el-table th {
  padding: 6px 0;
}

.inOxygenEditDiv .el-table td {
  padding: 4px 0;
}

.inOxygenEditDiv .el-input-number {
  line-height: 24px;
}

.inOxygenEditDiv .el-select-dropdown__list {
  padding: 0px 10px;
}

.inOxygenEditDiv ::-webkit-input-placeholder {
  font-style: italic;
}

@media screen and (min-aspect-ratio: 1001/1000) {
  /* 横屏 */
  .inOxygenEditDiv .el-form-item__label {
    font-size: 12px;
