...
namespace BLL
{
    public  class DataOracleHelper : IDataHelper
    {
        //数据库连接字符串
        ...
        public  override int ExecuteNonQuery(CommandType cmdType, string cmdText, string connString = null, params DbParameter[] commandParameters)
        {
        ...
        public   override DbDataReader ExecuteReader(CommandType cmdType, string cmdText, string connString = null, params DbParameter[] commandParameters)
        {
            OracleCommand cmd = new OracleCommand();
            if (connString == null)
            {
        ...
        /// <param name="commandParameters">执行命令所用参数的集合</param>
        /// <returns>包含结果的读取器</returns>
        public   override DataSet GetDataSet(CommandType cmdType, string cmdText, string connectionString = "", params DbParameter[] commandParameters)
        {
        ...
        public   override object ExecuteScalar(CommandType cmdType, string cmdText, string connectionString = "", params DbParameter[] commandParameters)
        {
            OracleCommand cmd = new OracleCommand();
            if (string.IsNullOrEmpty( connectionString))
            {
