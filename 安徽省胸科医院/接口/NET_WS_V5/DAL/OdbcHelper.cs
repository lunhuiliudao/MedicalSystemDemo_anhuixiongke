...
{
    /// <summary>
    /// OdbcDataReaderHelper专门提供给广大用户用于高性能、可升级和最佳练习的sql数据操作
    /// </summary>
    public class OdbcHelper
    {
        ...
        /// <param name="commandParameters">执行命令所用参数的集合</param>
        /// <returns>包含结果的读取器</returns>
        public static OdbcDataReader ExecuteReader(OdbcConnection conn, CommandType cmdType, string cmdText, params OdbcParameter[] commandParameters)
        {
        ...
        private static void PrepareCommand(OdbcCommand cmd, OdbcConnection conn, OdbcTransaction trans, CommandType cmdType, string cmdText, OdbcParameter[] commandParameters)
        {
