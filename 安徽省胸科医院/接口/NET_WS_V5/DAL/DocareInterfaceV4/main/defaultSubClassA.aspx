<%@ Page Language="C#" AutoEventWireup="true" CodeFile="defaultSubClassA.aspx.cs" Inherits="DoCareEmr.defaultSubClassA" %>
						...
						<div style="width:100%;height:100%;overflow:auto">
							...
							<tbody id="data1">
								<tr>
									...
									<td align="center"><a href="Patient_history.aspx?patient_id=<%#Eval("HIS_PATIENT_ID")%>&visit_id=<%#Eval("HIS_VISIT_ID") %>&mr_class=<%#Convert.ToString(Eval("MR_CLASS"))=="麻醉"?("1001"):("1002")%>&his_no="  target="_parent">查看病历</a></td>
								</tr>
							</tbody>
							</ItemTemplate>
