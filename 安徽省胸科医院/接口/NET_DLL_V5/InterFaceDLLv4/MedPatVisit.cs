...
namespace InterFaceV5
{
	...
	/// </summary>
	[Serializable]
	public class MedPatVisit
	{
		#region define variable
		private string _patientId;
		private decimal _visitId;
		private string _deptAdmissionTo = String.Empty;
		...
		private string _patientClass = String.Empty;
		...
		{
			get {return _deptAdmissionTo;}
			set {_deptAdmissionTo = value;}
		}
        ...
        public override bool Equals(object obj)
        {
            ...
            if (this.VisitId != Oper.VisitId)
                return false;
            if (this.DeptAdmissionTo != Oper.DeptAdmissionTo)
                return false;
            ...
            if (this.NextOfKinPhone != Oper.NextOfKinPhone)
                return false;
            if (this.PatientClass != Oper.PatientClass)
                return false;
