...
namespace MedicalSystem.AnesIcuQuery.Common
{
    ...
    public class PinYinClass
    {
        ...
        //string 中文简体 = Microsoft.VisualBasic.Strings.StrConv("中文繁体",
        //            Microsoft.VisualBasic.VbStrConv.SimplifiedChinese, 2052);
        ...
        public static string GetPinYin(string hz, bool f)
        {
            b();
            return c(hz, f);
        }
