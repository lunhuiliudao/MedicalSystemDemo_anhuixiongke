CREATE VIEW V_MED_ANES_INFO AS
SELECT M.PATIENT_ID,
       M.VISIT_ID,
       M.OPER_ID,
       M.DEPT_STAYED,
...
','+ M.FIRST_OPERATION_NURSE+','+
       ...
       M.START_DATE_TIME,
       CONVERT(NVARCHAR(10),M.START_DATE_TIME,120) AS OPER_DATE,
       M.END_DATE_TIME,
       ...
       CASE WHEN M.OUT_PACU_DATE_TIME IS NULL OR M.IN_PACU_DATE_TIME IS NULL THEN
         NULL
       ELSE
       convert(nvarchar(20),DATEPART(HOUR,M.OUT_PACU_DATE_TIME-M.IN_PACU_DATE_TIME) + ROUND(DATEPART(MINUTE,M.OUT_PACU_DATE_TIME-M.IN_PACU_DATE_TIME)/60,1)) + '小时'
       END AS PACU_TIME,
       M.OPERATION_ID,
       M.BLOOD_REUSE,
       M.SELF_BLOOD,
       ...
       I.NAME_PHONETIC,
       I.SEX,
       YEAR(M.SCHEDULED_DATE_TIME) - YEAR(I.DATE_OF_BIRTH) AS AGE,
       I.DATE_OF_BIRTH,
       I.BIRTH_PLACE,
       I.CITIZENSHIP,
       I.NATION,
  ...
  LEFT JOIN MED_ANESTHESIA_INPUT_DATA DA
