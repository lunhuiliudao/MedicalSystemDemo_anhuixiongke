...
--手术状态名
CASE A.OPER_STATUS WHEN 0 THEN '准备手术' WHEN 2 THEN '准备手术' WHEN 3 THEN '诱导室' WHEN 4 THEN '诱导室' WHEN 5 THEN '入手术室' WHEN 10 THEN '麻醉开始' WHEN 15 THEN '手术开始' WHEN 25 THEN '手术结束' WHEN 30 THEN '麻醉结束' WHEN 40 THEN '准备复苏' WHEN 45 THEN '入复苏室' WHEN 55 THEN '出复苏室' WHEN 60 THEN '回病房' WHEN 80 THEN '病案归档' WHEN -80 THEN '手术取消' END AS OPER_STATE,
--当前状态时间
