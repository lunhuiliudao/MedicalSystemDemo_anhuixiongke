...
SELECT
      ...
      NVL((SELECT V_DEPT_DICT.DEPT_NAME   FROM V_DEPT_DICT WHERE V_DEPT_DICT.DEPT_CODE = A.DEPT_STAYED ),A.DEPT_STAYED ) DEPT_STAYED,
       --C.BED_NO,                                           --床号
       A.BED_NO,
       NVL(A.START_DATE_TIME,A.SCHEDULED_DATE_TIME) SCHEDULED_DATE_TIME, --手术日期及时间
       --手术室
       A.OPERATING_ROOM,
      ...
      NVL((SELECT V_DEPT_DICT.DEPT_NAME   FROM V_DEPT_DICT WHERE V_DEPT_DICT.DEPT_CODE = A.OPERATING_DEPT ),A.OPERATING_DEPT ) OPERATING_DEPT,
       ...
       TO_DATE(NULL,'YYYY-MM-DD') REQ_TIME,                         --申请日期时间
       ...
       DECODE( A.OPER_STATUS, 0,'术前',2,'术前',3,'术中',4,'术中',5,'术中',10,'术中',15,'术中',25,'术中',30,'术中',35,'术后',40,'复苏',45,'复苏') END  TYPE,
       A.OPER_STATUS,
