--///麻醉一体机表视图映射
GRANT ALL ON  MED_OPERATING_ROOM TO MEDCOMM;
...
--手术状态
DECODE(A.OPER_STATUS_CODE,101,-80,A.OPER_STATUS_CODE) AS OPER_STATUS,
--手术科室代码
...
FROM MEDSURGERY.MED_OPERATION_MASTER A;
...
--手术体位
A.OPER_POSITION AS OPERATION_POSITION
FROM MEDSURGERY.MED_OPERATION_SCHEDULE A;
...
--///患者在院记录表视图
CREATE OR REPLACE VIEW V_PATS_IN_HOSPITAL
