...
namespace MedicalSystem.Anes.Document.Views
{
    ...
    public partial class BaseView : XtraUserControl
    {
        ...
        public virtual void SetDefaultGridViewStyle(DataGridView dgv, int RowHeight = 50, int ColumnHeight = 30)
        {
            if (dgv == null)
                return;
            ...
            dgv.DefaultCellStyle.Font = new System.Drawing.Font("微软雅黑", 10F);
            ...
            dgv.ColumnHeadersDefaultCellStyle.Font = new System.Drawing.Font("微软雅黑", 10F, FontStyle.Bold);
