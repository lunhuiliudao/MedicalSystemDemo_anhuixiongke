...
namespace MedicalSystem.Anes.Document.Designer
{
    ...
    [ToolboxItem(false)]
    public class DesignerContainer : System.Windows.Forms.UserControl, 
		IToolboxService
	{
		/// <summary>
		...
		private DesignerContainerTabCollection m_ToolboxTabCollection = null;
		...
		private void InitializeComponent()
		{
            ...
            this.toolboxTitleButton.Text = "π§æﬂœ‰";
		...
		{
			DesignerContainerXmlManager toolboxXmlManager = new DesignerContainerXmlManager(this);
			Tabs = toolboxXmlManager.PopulateToolboxInfo();

			DesignerContainerUIManagerVS toolboxUIManagerVS = new DesignerContainerUIManagerVS(this);
			toolboxUIManagerVS.FillDesignerContainer();
		...
		public DesignerContainerTabCollection Tabs
		{
			get
			{
		...
		private void PrintToolbox()
		{
			try
			{
				for(int i=0;i<Tabs.Count;i++)
				{
					...
					for(int j=0;j<Tabs[i].DesignerContainerItems.Count;j++)
						Console.WriteLine("\t" + Tabs[i].DesignerContainerItems[j].Type.ToString());
					Console.WriteLine(" ");
				}
			}
			catch(Exception ex)
		...
		private void list_DrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
		{
			try
			{
                ...
                string text = tbi.Description;
                if (string.IsNullOrEmpty(text))
                {
                    text = tbi.DisplayName;
                }
				e.Graphics.DrawString(text, new Font("ÀŒÃÂ", 11, FontStyle.Regular, GraphicsUnit.World), Brushes.Black, StringBounds, format);
			}
			catch(Exception ex)
			{
				ex.ToString();
			...
			try
			{
				...
				if (selectedIndex != 0)
				{
					...
					else if (e.Clicks < 2)
					{
						...
						// The IToolboxService serializes DesignerContainerItems by packaging them in DataObjects.
        ...
        public void AddToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem, string category)
		{
		}

        public void AddToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem)
		{
		}
        ...
        public void SetSelectedToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem)
		{
		}
        ...
        public void AddLinkedToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem, string category, IDesignerHost host)
		{
		}

        public void AddLinkedToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem, IDesignerHost host)
		{
		}
        ...
        public void RemoveToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem, string category)
		{
		}

        public void RemoveToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem)
		{
		}

        public object SerializeToolboxItem(System.Drawing.Design.ToolboxItem DesignerContainerItem)
		{
			return new DataObject (DesignerContainerItem);
		}
