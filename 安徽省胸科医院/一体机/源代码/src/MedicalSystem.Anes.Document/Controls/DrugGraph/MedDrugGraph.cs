...
namespace MedicalSystem.Anes.Document.Controls
{
    ...
    public partial class MedDrugGraph : AnesGraph, IPrintable
    {
        ...
        #region 属性
        //modified by joysola on 2018-2-23 新增用于记录MED_ANESTHESIA_EVENT所有属性的名字
        ...
        //modified by joysola on 2018-2-26 新增用于获取ApplicationConfiguration的属性
        /// <summary>
        /// 用药显示字符串
        /// </summary>
        ...
        /// <summary>
        /// 新增图例显示（药名）、用药显示字符串格式化处理函数 by joysola on 2018-2-27/28 
        /// </summary>
        /// <typeparam name="T">目前的类型MedDrugPoint、MedDrugCurve</typeparam>
        /// <param name="drug">输入类型</param>
        /// <param name="passedFormatText">格式化字符串</param>
        /// <returns></returns>
        #region GetPointDrugShowText2 ---废弃
        //private string GetPointDrugShowText2<T>(T drug, String passedFormatText)
        //{
        //    string[] formatArray = passedFormatText.Split(';');
        //    List<string> formatList = new List<string>();
        //    foreach (string itemArray in formatArray)
        //    {
        //        if (string.IsNullOrEmpty(itemArray))//为空不用加入集合
        //            continue;
        //        if (!PropertyNames.Contains(itemArray))//传过来的字符串中有新的格式直接加入集合
        //        {
        //            formatList.Add(itemArray);
        //        }
        //        foreach (string name in PropertyNames)
        //        {
        //            if (itemArray == name)//字段名加入
        //            {
        //                formatList.Add(itemArray);
        //            }
        //        }
        ...
        //    StringBuilder formatString = new StringBuilder();//最终的输出字符串
        //    if (drug.GetType() == typeof(MedDrugPoint))
        //    {
        //        var point = drug as MedDrugPoint;
        //        foreach (string item in formatList)
        //        {
        //            if (item.Equals("DOSAGE"))
        //            {
        //                if (string.IsNullOrEmpty(point.Value.ToString()) || point.Value.ToString() == "0")
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append(point.Value);
        //            }
        //            else if (item.Equals("DOSAGE_UNITS"))
        //            {
        //                formatString.Append("(" + point.Unit + ")");
        //            }
        //            else if (item.Equals("PERFORM_SPEED"))
        //            {
        //                if (point.Speed == 0)
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append(point.Speed);
        //            }

        //            else if (item.Equals("SPEED_UNIT"))
        //            {
        //                if (point.Speed == 0)
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append("(" + point.SpeedUnit + ")");
        //            }

        //            else if (item.Equals("CONCENTRATION"))
        //            {
        ...
        //                }
        //                else
        //                    formatString.Append(point.ThickNess);
        //            }

        //            else if (item.Equals("CONCENTRATION_UNIT"))
        //            {
        //                if (point.ThickNess == 0)
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append("(" + point.ThickNessUnit + ")");
        //            }
        //            else if (item.Equals("ADMINISTRATOR"))
        //            {
        ...
        //                }
        //                else
        //                    formatString.Append("(" + point.Route + ")");
        //            }
        //            else if (item.Contains("LeftBracket"))//单位的左标识
        //            {
        //                LeftBracket = item.Replace("LeftBracket", "");
        //            }
        //            else if (item.Contains("RightBracket"))//单位的右标识
        //            {
        //                RightBracket = item.Replace("RightBracket", "");
        //            }
        //            else//如果有新的格式但是MedDrugPoint中不存在，也直接加入(有问题，空白单位会出现问题)
        //            {
        ...
        //        foreach (string item in formatList)
        //        {
        //            if (item.Equals("EVENT_ITEM_NAME"))
        //            {
        //                formatString.Append(curve.Text);

        //            }
        //            else if (item.Equals("DOSAGE_UNITS"))
        //            {
        //                if (string.IsNullOrEmpty(curve.Unit))
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append("(" + curve.Unit + ")");

        //            }
        //            else if (item.Equals("SPEED_UNIT"))
        //            {
        //                if (string.IsNullOrEmpty(curve.SpeedUnit))
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append("(" + curve.SpeedUnit + ")");
        ...
        //                }
        //                else
        //                    formatString.Append("(" + point.ThickNessUnit + ")");//当前默认将“第一个点”的浓度单位显示
        //            }
        //            else if (item.Equals("ADMINISTRATOR"))//途径
        //            {
        //                if (string.IsNullOrEmpty(curve.Route))
        //                {
        //                    formatString.Append(string.Empty);
        //                }
        //                else
        //                    formatString.Append("(" + curve.Route + ")");
        //            }
        //            else if (item.Contains("LeftBracket"))//单位的左标识
        //            {
        //                LeftBracket = item.Replace("LeftBracket", "");
        ...
        //                RightBracket = item.Replace("RightBracket", "");
        //            }
        //            else//如果有新的格式但是MedDrugCurve中不存在，也直接加入(有问题，空白单位会出现问题)
        //            {
        //                formatString.Append(item);
        //            }
        ...
        //    }
        //    formatString = formatString.Replace("(", LeftBracket).Replace(")", RightBracket);//用格式化的字符串替换掉默认的“(”、“)”
        ...
        private void DrawLegend(Graphics g, int index)
        {
            ...
            if (_hasLegendSymbol)
            {
                ...
                float leftoff = string.IsNullOrEmpty(_title) ? 0f : _titleWidth;
                //modified by joysola on 2018-2-27、3-1 修改用药名称（图例）的显示格式
                // string text = GetPointDrugShowText2(curve, DrugNameShowFormatType);---废弃
                string text = ShowHelper.GetDrugNameShowText(curve, NameMarkFormat, DrugNameShowFormatType);
                //g.DrawString(AssemblyHelper.GetTextUnit(curve), font, textColorBrush, rect.X + 7 + g.MeasureString("A", font).Height + (int)leftoff, rect.Top + index * (_lineHeight + 1) + _topOffSet + 1);
            ...
            else
            {
                float leftoff = string.IsNullOrEmpty(_title) ? 0f : _titleWidth;
                //modified by joysola on 2018-2-27、3-1 修改用药名称（图例）的显示格式
                //string text = GetPointDrugShowText2(curve, DrugNameShowFormatType);
                string text = ShowHelper.GetDrugNameShowText(curve, NameMarkFormat, DrugNameShowFormatType);
                g.DrawString(text, font, textColorBrush, rect.X + 1 + leftoff, rect.Top + index * (_lineHeight + 1) + _topOffSet + 1);
                // g.DrawString(AssemblyHelper.GetTextUnit(curve), font, textColorBrush, rect.X + 1 + leftoff, rect.Top + index * (_lineHeight + 1) + _topOffSet + 1);
            }
