...
{
    [ToolboxItem(false)]
    public class DateEditingControl : DateEdit, IDataGridViewEditingControl
    {
        ...
        public DateEditingControl()
        {
            ...
            this.Properties.DisplayFormat.FormatString = "yyyy-MM-dd HH:mm";
            this.Properties.Mask.EditMask = "t";

            //this.DoubleClick += new EventHandler(DateEditingControl_DoubleClick);
        }

        //private void DateEditingControl_DoubleClick()
        //{ 
        ...
        private  void translateAlignment(DataGridViewContentAlignment align)
        {
        ...
        //            {
        //                Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.;
        //                Properties.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
        //            }
