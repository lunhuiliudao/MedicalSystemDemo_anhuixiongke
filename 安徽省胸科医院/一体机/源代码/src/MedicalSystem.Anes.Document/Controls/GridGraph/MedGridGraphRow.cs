...
namespace MedicalSystem.Anes.Document.Controls
{
    ...
    public class MedGridGraphRow
    {
        ...
        private bool _autoCalcTotal = false;
        ...
        public string Unit
        {
            get
            {
                ...
                {
                    foreach (MedGridPoint point in _points)
                    {
        ...
        public string ThickNessUnit
        {
            get
            {
                if (string.IsNullOrEmpty(_thickNessUnit))
                {
                    foreach (MedGridPoint point in _points)
                    {
                        if (!string.IsNullOrEmpty(point.ThickNessUnit))
                        {
                            _thickNessUnit = point.ThickNessUnit;
                            break;
                        }
                    }
                }
