namespace MedicalSystem.AnesWorkStation.Domain
{
    ...
    /// 实体 
    /// </summary>
    [Table("MED_LUTZ_SCORING_RESULT")]
    public partial class MED_LUTZ_SCORING_RESULT : BaseModel
    {
                [Key]
        ...
        public Nullable<Int32> S10 { get; set; }
        public Nullable<Int32> S11 { get; set; }
        public Nullable<Int32> S12 { get; set; }
        public Nullable<Int32> S13 { get; set; }
        public Nullable<Int32> S14 { get; set; }
        public Nullable<Int32> S15 { get; set; }
