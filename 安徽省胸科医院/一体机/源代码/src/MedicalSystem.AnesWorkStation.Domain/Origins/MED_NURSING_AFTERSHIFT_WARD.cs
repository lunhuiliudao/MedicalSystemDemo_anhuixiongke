namespace MedicalSystem.AnesWorkStation.Domain
{
    ...
    /// 
    /// </summary>
    [Table("MED_NURSING_AFTERSHIFT_WARD")]
    public partial class MED_NURSING_AFTERSHIFT_WARD : BaseModel
    {
        /// <summary>
        /// 主键 病人ID	;非空，唯一确定手术病人
        /// </summary>
        ...
        public string JBLX_NURSE { get; set; }
        public string KTJB_SSMC { get; set; }
        public string KTJB_SSBW { get; set; }
        public string KTJB_MZFS { get; set; }
        public string KTJB_SSTW { get; set; }
        public string KTJB_ZXD { get; set; }
        public string KTJB_CXL { get; set; }
        ...
        public string FS_BQ { get; set; }
        public string FS_BQ_NURSE { get; set; }
