namespace MedicalSystem.Anes.CustomProject
{
    partial class EditEventItem
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtDosageUnit = new MedicalSystem.Anes.CustomProject.Views.DictTextBox();
            this.txtDosage = new MedicalSystem.Anes.Document.Controls.MedTextBox();
            this.txtSpeedUnit = new MedicalSystem.Anes.CustomProject.Views.DictTextBox();
            this.txtSpeed = new MedicalSystem.Anes.Document.Controls.MedTextBox();
            this.txtPathUnit = new MedicalSystem.Anes.CustomProject.Views.DictTextBox();
            this.txtDensity = new MedicalSystem.Anes.CustomProject.Views.DictTextBox();
            this.txtPath = new MedicalSystem.Anes.CustomProject.Views.DictTextBox();
