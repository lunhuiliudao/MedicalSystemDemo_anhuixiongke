// ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
// 文件名称(File Name)：      PatientHandoverDoc.cs
// 功能描述(Description)：    患者交接对应的实体类
// 数据表(Tables)：		      无
// 作者(Author)：             MDSD
// 日期(Create Date)：        2018/06/26 19:28
// R1:
//    修改作者:
//    修改日期:
//    修改理由:
...
{
    public partial class PatientHandoverDoc : CustomBaseDoc
    {
        private int pageCount = 1;                              // 文书页数

        public PatientHandoverDoc()
        {
            InitializeComponent();
