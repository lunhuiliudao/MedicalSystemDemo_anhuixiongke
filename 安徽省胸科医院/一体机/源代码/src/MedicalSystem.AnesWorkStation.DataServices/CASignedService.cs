...
{
    public interface ICASignedService
    {
        /// <summary>
        /// 获取签名数据
        /// </summary>
    ...
    public class CASignedService : BaseService<PlatformAnesQueryService>, ICASignedService
    {
        protected CASignedService()
            : base() { }
        public CASignedService(IDapperContext context)
            : base(context)
        {
        ...
        public int SaveSignData(string patientId, decimal visitId, decimal operId, string signDocName, string signName, string controlId, string signImage)
        {
            ...
            try
            {
                ...
                do//先执行一次，再判断。  
                {
                    ...
                    bjcaSign.VISIT_ID =Convert.ToInt32( visitId);

                    bjcaSign.OPER_ID = Convert.ToInt32(operId);
