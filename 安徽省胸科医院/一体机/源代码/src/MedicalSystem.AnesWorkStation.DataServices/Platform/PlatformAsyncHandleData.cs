...
namespace MedicalSystem.AnesWorkStation.DataServices
{
    ...
    /// 处理第三方数据
    /// </summary>
    public class PlatformAsyncHandleData
    {
                ...
                using (var content = new MultipartFormDataContent())//表明是通过multipart/form-data的方式上传数据
                {
                    ...
                    try
                    {
                        ...
                        if (result.StatusCode == HttpStatusCode.OK)
                        {
                            ...
                            var jsonData = JsonConvert.DeserializeObject<PlatformResponseResult>(JsonConvert.DeserializeObject(mes).ToString());
    ...
    public class PlatformResponseResult
    {
        /// <summary>
        /// 状态
        /// </summary>
