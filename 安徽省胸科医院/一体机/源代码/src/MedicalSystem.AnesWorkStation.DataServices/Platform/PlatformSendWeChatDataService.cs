...
{
    public interface IPlatformSendWeChatData
    {
        #region  手术信息界面
        //查询手术信息
    ...
    public class PlatformSendWeChatDataService : BaseService<PlatformAnesQueryService>, IPlatformSendWeChatData
    {
        protected PlatformSendWeChatDataService()
            : base() { }
...
(select count(1) from (
            ...
            {
                Logger.Error("查询手术信息GetOperInfo:", ex);
                return null;
            }
        }
        #endregion
        ...
        public dynamic GetWeiXinOperInfo(OperQueryParaModel model)
        {
            ...
            if (model.TimeType == "month")
            {
                ...
                {
                    Logger.Error("查询手术信息GetWeiXinOperInfo:" + model.TimeType, ex);
                    return null;
                }
            }
        ...
        public IList<dynamic> QueryRightEChartReportForDirectionIndex(OperQueryParaModel model)
        {
            ...
            if (model.QueryType == "ASA")
            {
                ...
                ";
                    ...
                    {
                        Logger.Error("查询ASA分级信息QueryRightEChartReportForDirectionIndex:" + model.TimeType, ex);
                        return null;
                    }
                }
                else if (model.TimeType == "year")
            ...
            else if (model.QueryType == "AnesMethod")
            {
                if (model.TimeType == "month")
                {
                    ...
                    {
                        Logger.Error("查询麻醉方法信息QueryRightEChartReportForDirectionIndex:" + model.TimeType, ex);
                        return null;
                    }
                }
                else if (model.TimeType == "year")
        ...
        public List<MED_QC_REPORT_IND> GetQuanlityControlReportInd()
        {
            ...
            {
                Logger.Error("获取质控主索引报表数据GetQuanlityControlReportInd:", ex);
                return null;
            }
        }
        ...
        public List<MED_QC_REPORT_DATA_BAK> GetQuanlityControlReportDataBak(string reportName)
        {
            ...
            {
                Logger.Error("获取质控备份数据GetQuanlityControlReportDataBak:", ex);
                return null;
            }
        }
        ...
        public IList<MED_QC_REPORT_LIST> GetQuanlityControlReportList()
        {
            ...
            {
                Logger.Error("获取质控报表样式GetQuanlityControlReportList:", ex);
                return null;
            }
        }
        ...
        public DateTime GetSysDate()
        {
            ...
            try
            {
                return Convert.ToDateTime(dapper.Set<dynamic>().Query(sql)[0].SYSDATE);
            }
            catch (Exception ex)
            {
                Logger.Error("获取系统时间GetSysDate:", ex);
                return DateTime.Now;
            }
        }
