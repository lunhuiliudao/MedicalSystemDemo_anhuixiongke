...
using MedicalSystem.AnesPlatform.Service.WebApi;
...
namespace MedicalSystem.AnesPlatform.Service.WebApi
{
...
apiDesc.GetControllerAndActionAttributes<ControllerGroupAttribute>().First().Useage : "ÎÞÄ£¿é¹éÀà");
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.InjectJavaScript(thisAssembly, "MedicalSystem.AnesPlatform.Service.WebApi.App_Start.Swagger.swaggerui.swagger_lang.js");
