...
namespace MedicalSystem.Anes.Document.Documents
{
    public class DataTemplate
    {
        ...
        public DataTable GetSignRictTextBoxDt()
        {
            ...
            row["ControlName"] = this._currentMRichTextBox.Name;
            row["ControlValue"] = string.IsNullOrEmpty(this._currentMRichTextBox.Data.ToString()) ? this._currentMRichTextBox.Text : this._currentMRichTextBox.Data;
        ...
        private void SetQingdianViewData(string templetGuid, bool isAdd)
        {
            ...
            List<MED_QIXIE_TEMPLET_DETAIL> qiXieTempletDetail = CommonService.ClientInstance.GetQiXieTempletDetail(templetGuid);
