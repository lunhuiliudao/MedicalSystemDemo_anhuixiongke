...
namespace MedicalSystem.Anes.Client.CustomProject
{
    ...
    public partial class AnesDoc : CustomBaseDoc
    {
        ...
        public AnesDoc()
        {
            ...
            ExtendApplicationContext.Current.EventNo = "0";
        ...
        protected override void BuildData(Dictionary<string, DataTable> dataSource)
        {
            ...
            List<MLabel> lables = GetControls<MLabel>();
            foreach (MLabel lable in lables)
            {
                if (lable.Name.Equals("DocTitle"))
                {
                    lable.Text = ExtendApplicationContext.Current.HospitalName;
                    if (!ExtendAppContext.Current.IsPrintTitle)
                    {
                        lable.Visible = false;
                    }
                    else
        ...
        protected override void OnSaveData(Dictionary<string, DataTable> dataSource)
        {
            ...
            List<MED_PATS_IN_HOSPITAL> patsInHospitalList = ModelHelper<MED_PATS_IN_HOSPITAL>.ConvertDataTableToList(dataSource["MED_PATS_IN_HOSPITAL"]);
            ...
            //OperationInfoService.SaveMedicalBasicDoc(operMaster, patIndex, patVisit, patsInHospital, anesPlan, anesPlanExam, anesPlanPMH, operExtended, null, null);
