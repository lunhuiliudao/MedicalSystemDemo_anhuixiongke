...
namespace MedicalSystem.Anes.Client.FrameWork
{
    public class PermissionProvider
    {
        ...
        public virtual PermissionContext.RightType CheckRight(string text)
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                switch (text.Trim())
                {
                    ...
                    default:
                        if (AccessControl.CheckPermission(text))
                        {
                            result = PermissionContext.RightType.Modify | PermissionContext.RightType.Browse;
                        }
                        break;
        ...
        public PermissionContext.RightType GetAnesBillRightType(string rightKey)
        {
            ...
            MED_OPERATION_MASTER operationMasterRow = operationInfoRepository.GetOperMaster(ExtendApplicationContext.Current.PatientContextExtend.PatientID, ExtendApplicationContext.Current.PatientContextExtend.VisitID, ExtendApplicationContext.Current.PatientContextExtend.OperID).Data;
            List<MED_OPERATION_SHIFT_RECORD> operationShift = operationInfoRepository.GetShiftRecordListByID(ExtendApplicationContext.Current.PatientContextExtend.PatientID, ExtendApplicationContext.Current.PatientContextExtend.VisitID, ExtendApplicationContext.Current.PatientContextExtend.OperID).Data;
