namespace MedicalSystem.Anes.Client.FrameWork
{
    partial class MessageBoxFormPC
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.buttonColorExit = new MedicalSystem.Anes.Client.FrameWork.ButtonColor();
            ...
            this.textBoxMsg.Font = new System.Drawing.Font("Tahoma", 12F);
            ...
            // buttonColorOK
            // 
            this.buttonColorOK.ButtonColorType = MedicalSystem.Anes.Client.FrameWork.ButtonColor.ButtonType.蓝色;
            ...
            // buttonColorExit
            // 
            this.buttonColorExit.ButtonColorType = MedicalSystem.Anes.Client.FrameWork.ButtonColor.ButtonType.灰色;
            ...
            this.buttonColorExit.BtnClicked += new MedicalSystem.Anes.Client.FrameWork.ButtonColor.BtnClickHandle(this.buttonColorExit_BtnClicked);
            // 
            // pictureBoxMsgIco
            // 
            this.pictureBoxMsgIco.Image = global::MedicalSystem.Anes.Client.FrameWork.Properties.Resources.警告;
