...
namespace MedicalSystem.Anes.Client.AppPC
{
    ...
    public class TransMessageManager
    {
        ...
        private string MedicalSystemMessageServerURL =  ConfigurationManager.AppSettings["MedicalSystemMessageServerURL"];           //消息平台ip地址
        ...
        public LoginModel CurLoginModel
        {
            get
            {
                if (null == this.curLoginModel)
                {
                    ...
                    // 一体机的信息
                    string information = "手术间-" + ExtendApplicationContext.Current.OperRoomNo;
                    this.curLoginModel = new LoginModel(sessionID, "Ane", EnumAppType.AnesWorkStation,
                                                        ExtendApplicationContext.Current.LoginUser.USER_JOB_ID,
                                                        ExtendApplicationContext.Current.LoginUser.USER_NAME, information,
                                                        MedicalSystemMessageServerURL, childSessionID);
                }
            ...
            get
            {
                if (null == this.childLoginModel)
                {
                    this.childLoginModel = new LoginModel(this.CurLoginModel.ChildSessionID, "Ane",
                                                          ...
                                                          ExtendApplicationContext.Current.LoginUser.USER_JOB_ID,
                                                          ExtendApplicationContext.Current.LoginUser.USER_NAME,
