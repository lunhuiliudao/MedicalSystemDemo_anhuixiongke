...
namespace MedicalSystem.Anes.Client.AppPC
{
    public class DictTextBox : MedTextBox
    {
        ...
        private void ShowSeletion(MedTextBox textbox)
        {
            ...
            if (textbox.DictTableName.ToUpper().Equals("MED_OPERATING_ROOM"))
            {
                List<MED_OPERATING_ROOM> roomList = comnDictRepository.GetOperatingRoomList("1").Data;
                DataTable dt = ModelHelper<MED_OPERATING_ROOM>.ConvertListToDataTable(roomList);
                ExtendApplicationContext.Current.CodeTables[textbox.DictTableName] = dt;
            }
