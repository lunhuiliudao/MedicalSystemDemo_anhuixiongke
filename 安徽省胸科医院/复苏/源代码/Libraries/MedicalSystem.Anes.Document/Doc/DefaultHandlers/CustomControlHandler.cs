    ...
    public class CustomControlHandler : UIElementHandler<CustomControl>
    {
        ...
        { 
            ...
            if (!control.IsItemsLoaded)
            {
                ...
                {
                    //DataTable table = ExtendApplicationContext.Current.CodeTables[control.DictTableName.ToUpper()];
        ...
        {
        //    if (!string.IsNullOrEmpty(control.DictTableName) && !ExtendApplicationContext.Current.CodeTables.ContainsKey(control.DictTableName.ToUpper()))
