...
namespace MedicalSystem.Anes.Document.Controls
{
    ...
    /// 基本输入框
    /// </summary>
    [ToolboxItem(false), Description("输入框")]
    public class MedRichTextBox : DevExpress.XtraEditors.MemoEdit, ICheckable, IPrintable//TextBox, ICheckable, IPrintable
    {

        /// <summary>
        /// 构造方法
        /// </summary>
        public MedRichTextBox()
        {
        ...
        public void Draw(Graphics g, float x, float y)
        {
            ...
            if (Width < 20)
                return;
            List<SizeSplitIndexFlag> sizeIndexFlagList = GetListOfSizeSplitIndex(Font, Text, Width-20);
            ...
            for (int i = 0; i < sizeIndexFlagList.Count; i++)
            {
                ...
                {
                    g.DrawString(Text.Substring(sizeSplitIndexFlag.indexHead, sizeSplitIndexFlag.indexLast - sizeSplitIndexFlag.indexHead), Font, brush, new PointF(x + sizeSplitIndexFlag.indexLeft, y + sizeSplitIndexFlag.indexTop));
                }
    ...
    public class SizeSplitIndexFlag
    {
        public int indexHead = 0;
        public int indexLast = 0;

        public int indexLeft = 0; //行首位置
        public int indexTop = 0;//行首位置
