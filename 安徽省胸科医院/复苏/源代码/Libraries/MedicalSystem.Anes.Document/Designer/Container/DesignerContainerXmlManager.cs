        ...
        private void PopulateDesignerContainerItems(DesignerContainerTab DesignerContainerTab)
        {
            ...
            switch (DesignerContainerTab.Name)
            {
                case Strings.WindowsForms:
                    //typeArray = new Type[] { typeof(WindowsApplication1.MyListControl) };// {System.Reflection.Assembly.Load("WindowsApplication1").GetType("WindowsApplication1.MyListControl")};
                    typeArray = new Type[] { typeof(MLabel), typeof(MTextBox), typeof(CustomControl), typeof(MedGridView), typeof(MRichTextBox),typeof(MPanel)
                        , typeof(MedDateTimer), typeof(MedMyLine), typeof(MedVitalSignGraph), typeof(MedAnesSheetDetails), typeof(MedDrugGraph),typeof(Panel),typeof(MedSheet)
                        , typeof(MedGridGraph) ,typeof(NewPictureBox),typeof(MedButton),typeof(DrugContent),typeof(MedBloodGasGraph),typeof(MedLiquidStat),typeof(MedLegengGraph)};
