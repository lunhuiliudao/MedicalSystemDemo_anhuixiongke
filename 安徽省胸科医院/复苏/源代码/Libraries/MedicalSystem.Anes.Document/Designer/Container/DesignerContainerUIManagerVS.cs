...
{
	/// <summary>
    /// DesignerContainerUIManagerVS
	/// </summary>
	public class DesignerContainerUIManagerVS
	{
        private DesignerContainer m_toolbox;
		private System.Drawing.Design.ToolboxItem pointer; // a "null" tool
        public DesignerContainerUIManagerVS(DesignerContainer toolbox)
		{
			m_toolbox = toolbox;
		...
		public void FillDesignerContainer()
		{
			CreateControls();
			ConfigureControls();
			UpdateDesignerContainerItems(Toolbox.Tabs.Count - 1);
		}
		...
		private void button_Click(object sender, EventArgs e)
		{
			...
			UpdateDesignerContainerItems(index);
		}
